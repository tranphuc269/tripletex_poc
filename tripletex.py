...
class Tripletex:
    ...
    def create_session_token(self):
        params = {'consumerToken': self.consumer_token, 'employeeToken': self.employee_token,
                  'expirationDate': self.expiration_date}
        print('url :: ' + f'{self.base_url}/token/session/:create')
    ...
    def update_project(self, id, payload):
        r = requests.put(f'{self.base_url}/project/{id}', data=json.dumps(payload), auth=self.auth,
