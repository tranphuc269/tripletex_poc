...
def create_product(name):
    payload = {
        'name': name,
        # 'priceExcludingVatCurrency': 266,
        'priceIncludingVatCurrency': 267,
        # 'account': {
        #     "id": 122308421,
        #     "name": "phuctv14"
        # },
                ...
                'product':
                    {
                        ...
                        # },
                        'costPrice': 100,
                        'costExcludingVatCurrency': 95
                    },
                'amountExcludingVatCurrency': 95,
                'amountIncludingVatCurrency': 100
            }
        ],
...
if __name__ == '__main__':
    ...
    # department = create_department('The Fun Dept3333')
    # print(">>> department = create_department('The Fun Dept') :: {}".format(department))
    ...
    # product = create_product('Cool Product03').value
    # print(f">> product '{product.name}' has been created with product id '{product.id}'")
    #
    # print(">> creating customer")
    # customer = create_customer('phuctv14-customer2').value
    ...
    # order = create_order(customer.id, customer.name, product.id, order_date=order_date,
    ...
    create_report = client.post_file_report()
